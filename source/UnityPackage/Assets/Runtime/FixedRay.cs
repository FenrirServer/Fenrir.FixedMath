...
namespace FixedMath
{
    ...
    public struct FixedRay : IEquatable<FixedRay>
    {
        ...
        public Fixed? Intersects(FixedBoundingBox box)
        {
            ...
            Fixed? tMin = null, tMax = null;

            if (Fixed.Abs(Direction.X) < Epsilon)
            {
            ...
            if (Fixed.Abs(Direction.Y) < Epsilon)
            {
            ...
            if (Fixed.Abs(Direction.Z) < Epsilon)
            {
            ...
            if ((tMin.HasValue && tMin < Fixed.Zero) && tMax > Fixed.Zero) return Fixed.Zero;

            // a negative tMin means that the intersection point is behind the ray's origin
            // we discard these as not hitting the AABB
            if (tMin < Fixed.Zero) return null;
        ...
        /*
        public Fixed? Intersects(BoundingFrustum frustum)
        {
            if (frustum == null)
			{
        ...
        */
        ...
        public void Intersects(ref FixedBoundingSphere sphere, out Fixed? result)
        {
            ...
            Fixed dist = sphereRadiusSquared + distanceAlongRay * distanceAlongRay - differenceLengthSquared;

            result = (dist < Fixed.Zero) ? null : distanceAlongRay - (Fixed?)Fixed.Sqrt(dist);
        }
