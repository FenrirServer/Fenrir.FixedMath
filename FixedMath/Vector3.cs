...
namespace FixedMath
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        private static readonly Vector3 zero = new Vector3(Fixed.Zero, Fixed.Zero, Fixed.Zero);
        private static readonly Vector3 one = new Vector3(Fixed.One, Fixed.One, Fixed.One);
        private static readonly Vector3 unitX = new Vector3(Fixed.One, Fixed.Zero, Fixed.Zero);
        private static readonly Vector3 unitY = new Vector3(Fixed.Zero, Fixed.One, Fixed.Zero);
        private static readonly Vector3 unitZ = new Vector3(Fixed.Zero, Fixed.Zero, Fixed.One);
        private static readonly Vector3 up = new Vector3(Fixed.Zero, Fixed.One, Fixed.Zero);
        private static readonly Vector3 down = new Vector3(Fixed.Zero, -Fixed.One, Fixed.Zero);
        private static readonly Vector3 right = new Vector3(Fixed.One, Fixed.Zero, Fixed.Zero);
        private static readonly Vector3 left = new Vector3(-Fixed.One, Fixed.Zero, Fixed.Zero);
        private static readonly Vector3 forward = new Vector3(Fixed.Zero, Fixed.Zero, -Fixed.One);
        private static readonly Vector3 backward = new Vector3(Fixed.Zero, Fixed.Zero, Fixed.One);
        ...
        /// <param name="y">The y coordinate in 3d-space.</param>
        /// <param name="z">The z coordinate in 3d-space.</param>
        public Vector3(Fixed x, Fixed y, Fixed z)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
        ...
        /// <param name="z">The z coordinate in 3d-space.</param>
        public Vector3(Vector2 value, Fixed z)
        {
            this.X = value.X;
            this.Y = value.Y;
            this.Z = z;
        ...
        public static Vector3 Barycentric(Vector3 value1, Vector3 value2, Vector3 value3, Fixed amount1, Fixed amount2)
        {
            return new Vector3(
        ...
        public static void Barycentric(ref Vector3 value1, ref Vector3 value2, ref Vector3 value3, Fixed amount1, Fixed amount2, out Vector3 result)
        {
        ...
        public static Vector3 CatmullRom(Vector3 value1, Vector3 value2, Vector3 value3, Vector3 value4, Fixed amount)
        {
            return new Vector3(
        ...
        public static void CatmullRom(ref Vector3 value1, ref Vector3 value2, ref Vector3 value3, ref Vector3 value4, Fixed amount, out Vector3 result)
        {
        ...
        public static Fixed Distance(Vector3 value1, Vector3 value2)
        {
            Fixed result;
        ...
        public static void Distance(ref Vector3 value1, ref Vector3 value2, out Fixed result)
        {
            DistanceSquared(ref value1, ref value2, out result);
        ...
        public static Fixed DistanceSquared(Vector3 value1, Vector3 value2)
        {
        ...
        public static void DistanceSquared(ref Vector3 value1, ref Vector3 value2, out Fixed result)
        {
        ...
        public static Vector3 Divide(Vector3 value1, Fixed divider)
        {
        ...
        public static void Divide(ref Vector3 value1, Fixed divider, out Vector3 result)
        {
            Fixed factor = Fixed.One / divider;
        ...
        public static Fixed Dot(Vector3 value1, Vector3 value2)
        {
        ...
        public static void Dot(ref Vector3 value1, ref Vector3 value2, out Fixed result)
        {
        ...
        public static Vector3 Hermite(Vector3 value1, Vector3 tangent1, Vector3 value2, Vector3 tangent2, Fixed amount)
        {
            return new Vector3(Fixed.Hermite(value1.X, tangent1.X, value2.X, tangent2.X, amount),
        ...
        public static void Hermite(ref Vector3 value1, ref Vector3 tangent1, ref Vector3 value2, ref Vector3 tangent2, Fixed amount, out Vector3 result)
        {
        ...
        public static Vector3 Lerp(Vector3 value1, Vector3 value2, Fixed amount)
        {
            return new Vector3(
        ...
        public static void Lerp(ref Vector3 value1, ref Vector3 value2, Fixed amount, out Vector3 result)
        {
        ...
        /// Less efficient but more precise compared to <see cref="Vector3.Lerp(Vector3, Vector3, Fixed)"/>.
        ...
        /// <param name="amount">Weighting value(between 0.0 and 1.0).</param>
        /// <returns>The result of linear interpolation of the specified vectors.</returns>
        public static Vector3 LerpPrecise(Vector3 value1, Vector3 value2, Fixed amount)
        {
            return new Vector3(
        ...
        /// Creates a new <see cref="Vector3"/> that contains linear interpolation of the specified vectors.
        /// Uses <see cref="Fixed.LerpPrecise"/> on MathHelper for the interpolation.
        /// Less efficient but more precise compared to <see cref="Vector3.Lerp(ref Vector3, ref Vector3, Fixed, out Vector3)"/>.
        /// See remarks section of <see cref="Fixed.LerpPrecise"/> on MathHelper for more info.
        /// </summary>
        /// <param name="value1">The first vector.</param>
        /// <param name="value2">The second vector.</param>
        /// <param name="amount">Weighting value(between 0.0 and 1.0).</param>
        /// <param name="result">The result of linear interpolation of the specified vectors as an output parameter.</param>
        public static void LerpPrecise(ref Vector3 value1, ref Vector3 value2, Fixed amount, out Vector3 result)
        {
        ...
        public static Vector3 Multiply(Vector3 value1, Fixed scaleFactor)
        {
        ...
        public static void Multiply(ref Vector3 value1, Fixed scaleFactor, out Vector3 result)
        {
        ...
        public static Vector3 SmoothStep(Vector3 value1, Vector3 value2, Fixed amount)
        {
            return new Vector3(
        ...
        public static void SmoothStep(ref Vector3 value1, ref Vector3 value2, Fixed amount, out Vector3 result)
        {
        ...
        {
            return new Vector3((Fixed)value.X, (Fixed)value.Y, (Fixed)value.Z);
        }
        ...
        public static Vector3 operator *(Vector3 value, Fixed scaleFactor)
        {
            value.X *= scaleFactor;
            value.Y *= scaleFactor;
            value.Z *= scaleFactor;
        ...
        /// <returns>Result of the vector multiplication with a scalar.</returns>
        public static Vector3 operator *(Fixed scaleFactor, Vector3 value)
        {
            value.X *= scaleFactor;
            value.Y *= scaleFactor;
            value.Z *= scaleFactor;
        ...
        /// <returns>The result of dividing a vector by a scalar.</returns>
        public static Vector3 operator /(Vector3 value1, Fixed divider)
        {
            Fixed factor = Fixed.One / divider;
            value1.X *= factor;
            value1.Y *= factor;
