...
namespace FixedMath
{
    ...
    public partial struct Fixed : IEquatable<Fixed>, IComparable<Fixed>
    {
        ...
        public static readonly Fixed MaxValue = new Fixed(MAX_VALUE);
        public static readonly Fixed MinValue = new Fixed(MIN_VALUE);
        ...
        static readonly Fixed Log2Max = new Fixed(LOG2MAX);
        static readonly Fixed Log2Min = new Fixed(LOG2MIN);
        static readonly Fixed Ln2 = new Fixed(LN2);

        static readonly Fixed LutInterval = (Fixed)(LUT_SIZE - 1) / PiOver2;
        ...
        public static Fixed Abs(Fixed value)
        {
            ...
            return new Fixed((value.m_rawValue + mask) ^ mask);
        }
        ...
        public static Fixed Floor(Fixed value)
        {
            ...
            return new Fixed((long)((ulong)value.m_rawValue & 0xFFFFFFFF00000000));
        }
        ...
        {
            return new Fixed(x.m_rawValue + y.m_rawValue);
        }
        ...
        {
            return x.m_rawValue == MIN_VALUE ? MaxValue : new Fixed(-x.m_rawValue);
        }
        ...
        /// </summary>
        internal static Fixed Pow2(Fixed x)
        {
            if (x.m_rawValue == 0)
            {
                return One;
            ...
            if (x == One)
            {
                return neg ? One / (Fixed)2 : (Fixed)2;
            }
            if (x >= Log2Max)
            {
            ...
            x = new Fixed(x.m_rawValue & 0x00000000FFFFFFFF);
            ...
            {
                term = FastMul(FastMul(x, term), Ln2) / (Fixed)i;
                result += term;
                i++;
            }
        ...
        /// </exception>
        internal static Fixed Log2(Fixed x)
        {
            if (x.m_rawValue <= 0)
            {
        ...
        /// The argument was non-positive
        /// </exception>
        public static Fixed Ln(Fixed x)
        {
        ...
        /// </exception>
        public static Fixed Pow(Fixed b, Fixed exp)
        {
            if (b == One)
            {
                return One;
        ...
        /// This function has at least 7 decimals of accuracy.
        /// </summary>
        public static Fixed Atan(Fixed z)
        {
        ...
        public static Fixed Atan2(Fixed y, Fixed x)
        {
            ...
            // Deal with overflow
            if (One + (Fixed)0.28M * z * z == MaxValue)
            {
            ...
            {
                atan = PiOver2 - z / (z * z + (Fixed)0.28M);
                if (yl < 0)
                {
                    return atan - Pi;
                }
        ...
        {
            return obj is Fixed && ((Fixed)obj).m_rawValue == m_rawValue;
        }
        ...
        {
            return (Fixed)decimal.Parse(s, provider);
        }
    ...
    partial struct Fix64 
    {
        ...
        {");
                ...
                for (int i = 0; i < LUT_SIZE; ++i)
                {
                    ...
                    var rawValue = ((Fixed)sin).m_rawValue;
    ...
    partial struct Fix64 
    {
        ...
        {");
                ...
                for (int i = 0; i < LUT_SIZE; ++i)
                {
                    ...
                    var rawValue = (((decimal)tan > (decimal)MaxValue || tan < 0.0) ? MaxValue : (Fixed)tan).m_rawValue;
                    writer.Write(string.Format("0x{0:X}L, ", rawValue));
                }
                writer.Write(
@"
