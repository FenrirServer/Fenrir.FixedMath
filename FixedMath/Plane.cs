...
namespace FixedMath
{
	internal class PlaneHelper
    {
        ...
        public static Fixed ClassifyPoint(ref Vector3 point, ref Plane plane)
        {
        ...
        public static Fixed PerpendicularDistance(ref Vector3 point, ref Plane plane)
        {
    ...
    public struct Plane : IEquatable<Plane>
    {
        ...
        /// <param name="normal">The normal of the plane.</param>
        /// <param name="d">The distance to the origin.</param>
        public Plane(Vector3 normal, Fixed d)
        {
            Normal = normal;
            D = d;
        }
        ...
        /// <param name="d">The distance to the origin.</param>
        public Plane(Fixed a, Fixed b, Fixed c, Fixed d)
        ...
        public Fixed Dot(Vector4 value)
        {
        ...
        /// </param>
        public void Dot(ref Vector4 value, out Fixed result)
        {
        ...
        /// plus the <see cref="D"/> value of this <see cref="Plane"/>.
        /// </returns>
        public Fixed DotCoordinate(Vector3 value)
        {
        ...
        /// plus the <see cref="D"/> value of this <see cref="Plane"/>.
        /// </param>
        public void DotCoordinate(ref Vector3 value, out Fixed result)
        {
        ...
        /// The dot product of the specified <see cref="Vector3"/> and the normal of this <see cref="Plane"/>.
        /// </returns>
        public Fixed DotNormal(Vector3 value)
        {
        ...
        /// The dot product of the specified <see cref="Vector3"/> and the normal of this <see cref="Plane"/>.
        /// </param>
        public void DotNormal(ref Vector3 value, out Fixed result)
        {
        ...
        /// <param name="d"></param>
        public void Deconstruct(out Vector3 normal, out Fixed d)
        {
            normal = Normal;
            d = D;
        }
        ...
        {
            return new Plane(value.Normal, (Fixed)value.D);
        }
