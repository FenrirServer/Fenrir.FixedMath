...
namespace FixedMath
{
    ...
    class Bounding
    {
        ...
        public void BoundingSphereTests()
        {
            ...
            Assert.AreEqual(new BoundingSphere(new Vector3(Fixed.Half, Fixed.Half, Fixed.Half), (Fixed)0.8660254039M), twoPoint);
        ...
        public void BoundingFrustumToBoundingBoxTests()
        {
            ...
            var projection = Matrix.CreatePerspectiveFieldOfView(Fixed.PiOver4, (Fixed)1, (Fixed)1, (Fixed)100);
        ...
        public void BoundingFrustumToBoundingFrustumTests()
        {
            ...
            var projection2 = Matrix.CreatePerspectiveFieldOfView(Fixed.PiOver4, (Fixed)1, (Fixed)1, (Fixed)50);
            ...
            var projection4 = Matrix.CreatePerspectiveFieldOfView(Fixed.PiOver4, (Fixed)1, (Fixed)1, (Fixed)1000);
            ...
            var bf =
                new BoundingFrustum(Matrix.CreateLookAt(new Vector3(0, 1, 1), new Vector3(0, 0, 0), Vector3.Up) *
                                    Matrix.CreatePerspectiveFieldOfView(Fixed.PiOver4,
