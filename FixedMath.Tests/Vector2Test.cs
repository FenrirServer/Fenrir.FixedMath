...
namespace FixedMath
{
    class Vector2Test
    {
        ...
        public void CatmullRom()
        {
            ...
            var v1 = new Vector2(1, 2); var v2 = new Vector2(3, 4); var v3 = new Vector2(5, 6); var v4 = new Vector2(7, 8); Fixed value = (Fixed)1.0972f;
        ...
        public void Multiply()
        {
            ...
            // Test 0.0 scale.
            Assert.AreEqual(Vector2.Zero, (Fixed)0 * vector);
            Assert.AreEqual(Vector2.Zero, vector * (Fixed)0);
            Assert.AreEqual(Vector2.Zero, Vector2.Multiply(vector, (Fixed)0));
            Assert.AreEqual(Vector2.Multiply(vector, (Fixed)0), vector * (Fixed)0.0f);

            // Test 1.0 scale.
            Assert.AreEqual(vector, (Fixed)1 * vector);
            Assert.AreEqual(vector, vector * (Fixed)1);
            Assert.AreEqual(vector, Vector2.Multiply(vector, (Fixed)1));
            Assert.AreEqual(Vector2.Multiply(vector, (Fixed)1), vector * (Fixed)1.0f);
            ...
            Assert.AreEqual(scaledVec, Vector2.Multiply(vector, (Fixed)2));
            Assert.AreEqual(vector * (Fixed)2.0f, scaledVec);
            Assert.AreEqual((Fixed)2 * vector, Vector2.Multiply(vector, (Fixed)2));
            ...
            Assert.AreEqual(scaledVec, Vector2.Multiply(vector, (Fixed)0.999f));
            Assert.AreEqual(vector * (Fixed)0.999f, scaledVec);
            Assert.AreEqual((Fixed)0.999f * vector, Vector2.Multiply(vector, (Fixed)0.999f));
            ...
            vector3 = Vector2.Multiply(vector, (Fixed)2);
            Vector2.Multiply(ref vector, ref vector2, out refVec);
            Assert.AreEqual(vector3, refVec);
        }
        ...
        public void Hermite()
        {
            ...
            Assert.That(t1, Is.EqualTo(Vector2.Hermite(v1, v2, v3, v4, (Fixed)0.25f)).Using(Vector2Comparer.Epsilon));
            Assert.That(t2, Is.EqualTo(Vector2.Hermite(v5, v6, v7, v8, (Fixed)0.45f)).Using(Vector2Comparer.Epsilon));

            Vector2 result1;
            Vector2 result2;

            Vector2.Hermite(ref v1, ref v2, ref v3, ref v4, (Fixed)0.25f, out result1);
            Vector2.Hermite(ref v5, ref v6, ref v7, ref v8, (Fixed)0.45f, out result2);
        ...
        public void HashCode()
        {
            ...
            var max = new Vector2(Fixed.MaxValue, Fixed.MaxValue);
            var min = new Vector2(Fixed.MinValue, Fixed.MinValue);
