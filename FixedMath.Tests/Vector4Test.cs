...
namespace FixedMath
{
    class Vector4Tests
    {
        ...
        public void Constructors()
        {
            ...
            Assert.That(expectedResult, Is.EqualTo(new Vector4(new Vector2(1,2), (Fixed)3, (Fixed)4)).Using(Vector4Comparer.Epsilon));
            Assert.That(expectedResult, Is.EqualTo(new Vector4(new Vector3(1,2,3), (Fixed)4)).Using(Vector4Comparer.Epsilon));
        ...
        public void Hermite()
        {
            ...
            var expected = new Vector4((Fixed)39.0311012268M, (Fixed)34.6555709839, (Fixed)(-132.5473022461), (Fixed)(-2626.859375));
